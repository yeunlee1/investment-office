...
_POLICIES: Final = (
    ...
    _source(
        ...
        "공개 경제 시계열을 분석할 수 있으며 원자료 기관과 수정 이력을 함께 보존합니다.",
        SourceFreshness.RELEASE_SCHEDULE,
        "각 지표의 공식 발표 일정과 수정 주기를 따릅니다.",
        UseScope.ANALYSIS_ALLOWED,
        SourcePriority.PRIMARY,
        "https://fred.stlouisfed.org/docs/api/fred/",
        required_key_env_vars=("FRED_API_KEY",),
    ),
    _source(
    ...
    _source(
        ...
        "공개 VIX 기준 자료를 분석하며 실시간 재배포는 별도 계약 범위입니다.",
        SourceFreshness.END_OF_DAY,
        "무계약 기본 구성은 공식 지연 또는 종가 자료만 사용합니다.",
        UseScope.ANALYSIS_ALLOWED,
        SourcePriority.PRIMARY,
    ...
    _source(
        ...
        TrustLevel.LOW,
        LicenseScope.UNOFFICIAL_FALLBACK,
        "공식 서비스 수준 보장과 재배포 권한이 없으므로 교차검증용 장애 대응에만 사용합니다.",
        SourceFreshness.END_OF_DAY,
        "완료된 일봉만 사용하고 공식 또는 계약 공급원과 값이 다르면 폐기합니다.",
        UseScope.ANALYSIS_ALLOWED,
