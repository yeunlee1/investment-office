...
def test_site_uses_summary_hub_and_three_clear_pages() -> None:
    for href in ("/analysis", "/discovery", "/history"):
...
def test_site_templates_have_unique_ids_and_accessible_responsive_styles() -> None:
    for template in (BASE, HUB, ANALYSIS, HISTORY):
...
def test_new_site_source_files_start_with_korean_role_headers() -> None:
    for name in ("site-common.js", "hub.js", "analysis.js", "discovery.js", "history.js"):
